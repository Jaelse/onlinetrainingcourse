...
class SubscribersTest < ApplicationSystemTestCase
  ...
  test "creating a Subscriber" do
    ...
    fill_in "Citizenid", with: @subscriber.citizenid
    fill_in "Dept", with: @subscriber.dept
    fill_in "Fname", with: @subscriber.fname
    fill_in "Insorstid", with: @subscriber.insorstid
    fill_in "Lname", with: @subscriber.lname
    fill_in "Substype", with: @subscriber.substype
